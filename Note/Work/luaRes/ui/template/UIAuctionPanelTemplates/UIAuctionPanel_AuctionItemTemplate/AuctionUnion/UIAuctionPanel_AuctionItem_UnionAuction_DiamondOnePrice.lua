---@class UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:UIAuctionPanel_AuctionItem_AuctionBid 钻石交易行购买模板
local UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice = {}

setmetatable(UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice, luaComponentTemplates.UIAuctionPanel_AuctionItem_AuctionBid)

function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:GetMaxNum()
    return self.mCanBuyMaxNum;
end

function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:Init(data)
...
---点击数目增加
function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:OnAddBtnClicked(go)

end

---点击减少按钮
---交易行的逻辑，减少到最小值继续减少变成最大值，要修改可以重写此方法，一定要调用SetNum刷新
function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:OnReduceBtnClicked(go)

end
---刷新价格显示
function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:RefreshPriceShow()
...
---判断自己道具是否足够购买
function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:IsDiamondEnough(price)
...
function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:IsDiamondQuotaEnough(price)
    if self.AuctionInfo and self.AuctionInfo.price then
...
---点击购买按钮
function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:OnShelfClicked(go)
...
function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:GetIsBuy()
...
---刷新标题
function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:RefreshTitle()
    self.centerBtn_UILabel.text = "购买"
end

---输入数目改变
function UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice:NumChange(inputValue)
    self:SetNum()
end

return UIAuctionPanel_AuctionItem_UnionAuction_DiamondOnePrice