---仓库重写灵兽装备Tips
---@class UIWarehousePanel_UIItemInfoServantEquipMainPart:UIItemInfoPanel_ServantEquipMainPart
local UIWarehousePanel_UIItemInfoServantEquipMainPart = {}
setmetatable(UIWarehousePanel_UIItemInfoServantEquipMainPart, luaComponentTemplates.UIItemInfoPanel_ServantEquipMainPart)

---刷新右上角区域（重写右上角按钮）
---@param bagItemInfo bagV2.BagItemInfo 背包物品信息
---@param itemInfo TABLE.CFG_ITEMS
function UIWarehousePanel_UIItemInfoServantEquipMainPart:RefreshRightUpArea(bagItemInfo, itemInfo, isMainPlayer)
    --显示操作按钮
    if bagItemInfo then
...
---@param bagItemInfo bagV2.BagItemInfo 背包物品信息
---@param itemInfo TABLE.CFG_ITEMS
function UIWarehousePanel_UIItemInfoServantEquipMainPart:RefreshLowerArea(bagItemInfo, itemInfo)
    --道具描述
...
return UIWarehousePanel_UIItemInfoServantEquipMainPart