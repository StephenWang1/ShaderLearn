---仓库取出道具重写装备Tips模板
---@class UIWarehousePanel_TakeOutUIItemInfoMainPart:UIItemInfoPanel_MainPart
local UIWarehousePanel_TakeOutUIItemInfoMainPart = {}

setmetatable(UIWarehousePanel_TakeOutUIItemInfoMainPart, luaComponentTemplates.UIItemInfoPanel_MainPart)

---刷新右上角区域（重写右上角按钮）
---@param bagItemInfo bagV2.BagItemInfo 背包物品信息
---@param itemInfo TABLE.CFG_ITEMS
function UIWarehousePanel_TakeOutUIItemInfoMainPart:RefreshRightUpArea(bagItemInfo, itemInfo, isMainPlayer)
    --显示操作按钮
    if bagItemInfo then
...
---@param bagItemInfo bagV2.BagItemInfo 背包物品信息
---@param itemInfo TABLE.CFG_ITEMS
function UIWarehousePanel_TakeOutUIItemInfoMainPart:RefreshLowerArea(bagItemInfo, itemInfo)
    --道具描述
...
return UIWarehousePanel_TakeOutUIItemInfoMainPart