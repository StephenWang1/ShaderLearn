local UpgradeMembershipItemInfo_RightUpOperateButtons = {}
setmetatable(UpgradeMembershipItemInfo_RightUpOperateButtons,luaComponentTemplates.UIItemInfoPanel_Info_RightUpOperateButtons)

---使用信息刷新
---@param commonData UIItemTipInfoCommonData
function UpgradeMembershipItemInfo_RightUpOperateButtons:RefreshWithInfo(commonData)
    ...
    if itemInfo then
        ...
        local allOperateTable  = {LuaEnumItemOperateType.UpgradeMembership};
...
return UpgradeMembershipItemInfo_RightUpOperateButtons